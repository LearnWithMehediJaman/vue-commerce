        ...
        <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
            ...
            <form action="#" class="space-y-8">
                <div>
                    ...
                    <input v-model="message.email" type="email" id="email"
                ...
                <div>
                    ...
                    <input v-model="message.subject" type="text" id="subject"
                ...
                <div class="sm:col-span-2">
                    ...
                    <textarea v-model="message.message" id="message" rows="6"
                        class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg shadow-sm border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        placeholder="Leave a comment..."></textarea>
                </div>
                <button @click.prevent="sendMessage()" type="submit"
                    class="py-3 px-5 text-sm font-medium text-center bg-blue-700 text-white rounded-lg bg-primary-700 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Send
                    message</button>
            </form>
        </div>
    </section>
